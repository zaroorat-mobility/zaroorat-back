...
import { IDEMPOTENCY_OPERATIONS } from '@core/cache/keys.js';
...
export class IdempotencyRepository {
  ...
  async runIdempotent<T>(
    ...
    const stored = await this.redis.idempotency.get<StoredRecord<T>>(
      IDEMPOTENCY_OPERATIONS.PAYMENT,
      scopedKey,
    );
