...
- Verify production infrastructure readiness (Airtel DLT + SMS production verification, AWS RDS / GCP Cloud SQL 35-day PITR automated backup retention, Pino/Prometheus metrics).
...
- **Infrastructure Verification**: DB Backup/PITR, Airtel DLT + SMS production verification (Principal Entity registration, sender/header, templates, API credentials, endpoints, callbacks), Pino/Prometheus APM metrics.
