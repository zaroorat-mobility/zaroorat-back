...
| **R-FILE-29** | Location metadata (EXIF GPS) **SHALL** be stripped from images before they become readable, for every purpose except those where provenance is evidence (FILES-OD-10).                              |
