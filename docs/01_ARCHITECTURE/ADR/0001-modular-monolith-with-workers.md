...
- **Positive:** the coupled core loop stays fast and transactional (no network hops); async work scales independently; clean module boundaries let us extract a service later _if it earns it_.
