...
> **Answers:** *What events flow through the system — internal domain events and realtime socket events?*
...
- **Server-authoritative:** sockets *push* state, the DB *decides* it. On reconnect the client calls `GET /rides/:id` to reconcile.
